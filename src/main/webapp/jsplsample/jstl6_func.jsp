...
<h3>jstl6_func</h3>
<h4>split</h4>
<c:set var="str1" value="Java/Anderid/Sprint/Jsp/Servlet" />
...
<c:set var="str2" value="This is test string."/>
	...
	<c:set var="subStr1" value="${fn:substringAfter(str2, 'test') }"></c:set>
	<c:set var="subStr2" value="${fn:substringAfter(str2, 'This') }"></c:set>
	<c:out value="subStr1 - ${subStr1 }"/>
	<br />
	<c:out value="subStr2 - ${subStr2 }"/>

	<h3>substringBefore 사용 예제</h3>
	<c:set var="subStr1" value="${fn:substringBefore(str2, 'test') }"></c:set>
	<c:set var="subStr2" value="${fn:substringBefore(str2, 'This') }"></c:set>
	<c:out value="subStr1 - ${subStr1 }"/>
	<br />
	<c:out value="subStr2 - ${subStr2 }"/>
